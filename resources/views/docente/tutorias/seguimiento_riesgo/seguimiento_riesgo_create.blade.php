...
@section('titulo','Registrar alumno en riesgo')
	...
	<div class="profile-content">
		<div class="container">
			...
			<div class="description text-center">
				<h3 class="title">Registrar  seguimiento de alumno en riesgo</h3>
			</div>        					
			<form method="post" action="{{url('docente/tutorias/seguimientos_alumno_riesgo')}}">
				{{ csrf_field() }}
				...
				<div class="row border border-dark">
					...
					<div class="col-md-4 mb-5">
						...
						<input type="number" step="any" class="form-control" name="promedio_acumulado_ciclo_actual"
								 value="{{ old('promedio_acumulado_ciclo_actual') }}">
					</div>
					...
					<div class="col-md-12 mb-5">
						...
						<input type="text" class="form-control text-dark" placeholder="¿Cuál" name="beneficiario_beca_apoyo"
								value="{{ old('beneficiario_beca_apoyo') }}">
					</div>
				</div> 	
				<div class="row border border-dark mt-5">
					...
					<div class="col-md-12 mb-5">
						...
						<input type="text" class="form-control" placeholder="(Breve descripción)" name="contexto_familiar_alumno"
							   value="{{ old('contexto_familiar_alumno') }}">
					</div>
				</div> 
				<!--Docentes-->
				<div class="row border border-dark mt-5">
					...
					<div class="col-md-4 mt-2 mb-4">
						...
						<textarea class="form-control" rows="1" name="comentarios1">{{ old('comentarios1') }}</textarea>
					</div>
					<!--Docente 2-->
					<div class="col-md-4 mt-1 mb-4">
					...
					<div class="col-md-4 mt-2 mb-4">
						...
						<textarea class="form-control" rows="1" name="comentarios2">{{ old('comentarios2') }}</textarea>
					</div>
					<!--Docente 3-->
					<div class="col-md-4 mt-1 mb-4">
					...
					<div class="col-md-4 mt-2 mb-4">
						...
						<textarea class="form-control" rows="1" name="comentarios3">{{ old('comentarios3') }}</textarea>
					</div>
					<!--Docente 4-->
					<div class="col-md-4 mt-1 mb-4">
					...
					<div class="col-md-4 mt-2 mb-4">
						...
						<textarea class="form-control" rows="1" name="comentarios4">{{ old('comentarios4') }}</textarea>
					</div>
					<!--Docente 5-->
					<div class="col-md-4 mt-1 mb-4">
					...
					<div class="col-md-4 mt-2 mb-4">
						...
						<textarea class="form-control" rows="1" name="comentarios5">{{ old('comentarios5') }}</textarea>
					</div>
					<!--Docente 6-->
					<div class="col-md-4 mt-1 mb-4">
					...
					<div class="col-md-4 mt-2 mb-4">
						...
						<textarea class="form-control" rows="1" name="comentarios6">{{ old('comentarios6') }}</textarea>
					</div>
					<!--Docente 7-->
					<div class="col-md-4 mt-1 mb-4">
					...
					<div class="col-md-4 mt-2 mb-4">
						...
						<textarea class="form-control" rows="1" name="comentarios7">{{ old('comentarios7') }}</textarea>
					</div>
				</div> 
				<div class="row border border-dark mt-5">
					<h4 class="title text-center">
					...
					<div class="col-md-12 mt-2 mb-4">
						<textarea class="form-control" rows="3" name="desempeño_escolar">{{ old('desempeño_escolar') }}</textarea>
					</div>
				</div>	
				<div class="row border border-dark mt-5">
					...
					<div class="col-md-12 mt-2 mb-5">
						...
						<textarea class="form-control" rows="5" name="compromisos_acuerdos">{{ old('compromisos_acuerdos') }}</textarea>
					</div>
				</div><br>
				<div class="col-12 text-center">
