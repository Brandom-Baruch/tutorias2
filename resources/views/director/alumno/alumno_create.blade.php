...
<div class="main main-raised">
  <div class="container">             
    <div class="section">
      <h2 class="title text-center" style="color:black;">Registrar nuevo Alumno</h2>
        ...
        <div class="row"> 
          ...
          <div class="col-sm-2">
            ...
            <div class="form-group {{ $errors->has('phone') ? ' has-error' : '' }}">
              ...
              placeholder="Ejemplo: 123-123-1234" value="{{ old('phone') }}"
              name="phone">
            </div>
          ...
          <div class="col-sm-2">
            ...
            <div class="form-group {{ $errors->has('fechaN') ? ' has-error' : '' }}">
              ...
              placeholder="Ejemplo: 1998-08-28" value="{{ old('fechaN') }}"
              name="fechaN">                            
            </div>
